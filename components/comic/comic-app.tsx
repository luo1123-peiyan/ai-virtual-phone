...
// 拷贝漫画题材（path_word -> 中文名），全量对齐 Venera 官方 copy_manga.js。
const THEMES: { word: string; name: string }[] = [
  { word: "", name: "全部" },
  { word: "aiqing", name: "愛情" },
  { word: "huanlexiang", name: "歡樂向" },
  { word: "maoxian", name: "冒險" },
  { word: "qihuan", name: "奇幻" },
  { word: "baihe", name: "百合" },
  { word: "xiaoyuan", name: "校园" },
  { word: "kehuan", name: "科幻" },
  { word: "dongfang", name: "東方" },
  { word: "danmei", name: "耽美" },
  { word: "shenghuo", name: "生活" },
  { word: "gedou", name: "格鬥" },
  { word: "qingxiaoshuo", name: "轻小说" },
  { word: "xuanyi", name: "悬疑" },
  { word: "qita", name: "其他" },
  { word: "shengui", name: "神鬼" },
  { word: "zhichang", name: "职场" },
  { word: "teenslove", name: "TL" },
  { word: "mengxi", name: "萌系" },
  { word: "zhiyu", name: "治愈" },
  { word: "changtiao", name: "長條" },
  { word: "sige", name: "四格" },
  { word: "jiecao", name: "节操" },
  { word: "jianniang", name: "舰娘" },
  { word: "jingji", name: "竞技" },
  { word: "gaoxiao", name: "搞笑" },
  { word: "weiniang", name: "伪娘" },
  { word: "rexue", name: "热血" },
  { word: "lizhi", name: "励志" },
  { word: "xingzhuanhuan", name: "性转换" },
  { word: "COLOR", name: "彩色" },
  { word: "hougong", name: "後宮" },
  { word: "meishi", name: "美食" },
  { word: "zhentan", name: "侦探" },
  { word: "aa", name: "AA" },
  { word: "yinyuewudao", name: "音乐舞蹈" },
  { word: "mohuan", name: "魔幻" },
  { word: "zhanzheng", name: "战争" },
  { word: "lishi", name: "历史" },
  { word: "yishijie", name: "异世界" },
  { word: "jingsong", name: "惊悚" },
  { word: "jizhan", name: "机战" },
  { word: "dushi", name: "都市" },
  { word: "chuanyue", name: "穿越" },
  { word: "kongbu", name: "恐怖" },
  { word: "chongsheng", name: "重生" },
  { word: "shengcun", name: "生存" },
  { word: "zhaixi", name: "宅系" },
  { word: "wuxia", name: "武侠" },
  { word: "fate", name: "FATE" },
  { word: "zhuansheng", name: "转生" },
  { word: "Uncensored", name: "無修正" },
  { word: "xianxia", name: "仙侠" },
  { word: "loveLive", name: "LoveLive" },
];
    ...
    return (
      <div className="flex-1 overflow-y-auto pb-24 pt-12">
        <div className="flex items-center justify-between px-4 pb-1 pt-2">
          <button type="button" onClick={onClose} aria-label="退出漫画回桌面" className="flex items-center gap-1 text-2xl font-bold text-gray-800">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500"><path d="m15 18-6-6 6-6" /></svg>
            主页
          </button>
          <button type="button" onClick={() => setView("settings")} aria-label="设置" className="text-gray-500">
    ...
    return (
      <div className="flex flex-1 flex-col overflow-hidden pt-10">
        <div className="flex flex-none items-center gap-2 border-b px-3 pb-2 pt-2">
          ...
          <span className="text-base font-bold text-gray-800">{exploreTab === "category" ? "分类" : SOURCE_META[source].name}</span>
          <button
            type="button"
          ...
          <button type="button" onClick={() => setView("search")} className="text-gray-500" aria-label="搜索">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" /></svg>
          </button>
          <button type="button" onClick={() => setView("settings")} className="text-gray-500" aria-label="设置">
    ...
    <div className={"absolute inset-0 flex flex-col overflow-hidden " + (settings.dark ? "bg-neutral-900 text-gray-100" : "bg-gray-50")}>
      ...
      {showNav && (
        <nav className="flex flex-none items-center border-t bg-white pb-1 pt-1">
          ...
          <NavIcon label="探索" active={view === "explore" && exploreTab === "recommend"} onClick={openExplore} path="M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20zM16 8l-2 6-6 2 2-6z" />
          <NavIcon
            label="分类"
            active={view === "explore" && exploreTab === "category"}
            onClick={() => {
              setView("explore");
              setExploreTab("category");
              if (catComics.length === 0 && !catLoading) void loadCategory(theme, ordering, 1, false);
            }}
